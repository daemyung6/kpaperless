...
export default function Per_1({nextPage, contractData, setContractData}) {
    ...
    const styles = StyleSheet.create({
        ...
        canvas_view: {
            ...
            height: config.ratio.width * 1351 * (zoom / 100),
            marginLeft: 'auto',
            marginRight: 'auto',
        },
        canvas_view_img: {
            ...
            <ScrollView >
                <ScrollView horizontal={zoom < 120 ? false : true}>
                    <View style={styles.canvas_view}>
                        <Image style={styles.canvas_view} source={require('../../img/per-1.png')} />
                    </View>
                </ScrollView>
            </ScrollView>
