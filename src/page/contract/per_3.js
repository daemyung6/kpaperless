...
export default function Per_3({nextPage, contractData, setContractData}) {
    ...
    const styles = StyleSheet.create({
        ...
        canvas_view: {
            width: config.ratio.width * 865 * (zoom / 100),
            height: config.ratio.width * 1342 * (zoom / 100),
            marginLeft: 'auto',
            marginRight: 'auto',
        },
        canvas_view_img: {
            ...
            <ScrollView >
                <ScrollView horizontal={zoom < 120 ? false : true}>
                    <View style={styles.canvas_view}>
                        <Image style={styles.canvas_view} source={require('../../img/per-3.png')} />
                    </View>
                </ScrollView>
            </ScrollView>
